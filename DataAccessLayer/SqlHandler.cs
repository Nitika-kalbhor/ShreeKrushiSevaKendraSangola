...
namespace DataAccessLayer
{
    public class SqlHandler
    {
        ...
        /// <returns></returns>
       ///
 public int ExecuteNonQueryTM(string procedureName, List<KeyValuePair<string, object>> ParaMeterCollection, SqlConnection Conn, SqlTransaction trans)
        {
            try
            {
                int rs = 0;
        ...
        public long ExecuteAsScalar(string StroredProcedureName)
        {
            SqlConnection SQLConn = new SqlConnection(this._connectionString);
            try
            {
                ...
                {
                    maxID = (Int64)SQLCmd.ExecuteScalar() + 1;
                }
                else
                {
                    maxID = maxID + 1;
        ...
        public long ExecuteAsScalarLong(string StroredProcedureName, List<KeyValuePair<string, object>> ParaMeterCollection)
        {
            SqlConnection SQLConn = new SqlConnection(this._connectionString);
            try
            {
                ...
                if (SQLCmd.ExecuteScalar() != null)
                {
                    value = (Int64)SQLCmd.ExecuteScalar() + 1;
                }
                else
                {
                    value = value + 1;
        ...
        public double ExecuteAsScalar(string StroredProcedureName, List<KeyValuePair<string, object>> ParaMeterCollection)
        {
            SqlConnection SQLConn = new SqlConnection(this._connectionString);
            try
            {
                ...
                if (SQLCmd.ExecuteScalar() != null)
                {
                    value = (Double)SQLCmd.ExecuteScalar();
                }
                else
                {
                    value = 0;
        ...
        public double ExecuteAsScalar(string StroredProcedureName, List<KeyValuePair<string, string>> ParaMeterCollection)
        {
            SqlConnection SQLConn = new SqlConnection(this._connectionString);
            try
            {
        ...
        public bool ExecuteAsScalarBool(string StroredProcedureName, List<KeyValuePair<string, object>> ParaMeterCollection)
        {
            SqlConnection SQLConn = new SqlConnection(this._connectionString);
            try
            {
                ...
                if (SQLCmd.ExecuteScalar() != null)
                {
                    value = (Boolean)SQLCmd.ExecuteScalar();
                }
                else
                {
                    value = false;
